...
#ifndef AT91RM9200_H_
#define AT91RM9200_H_
...
#define AT91C_TC_CLKS_MCK_2   ((unsigned int) 0)         // (TC) Clock Selection MCK/2
#define AT91C_TC_CLKS_MCK_8   ((unsigned int) 0x1)       // (TC) Clock Selection MCK/8
#define AT91C_TC_CLKS_MCK_32  ((unsigned int) 0x2)       // (TC) Clock Selection MCK/32
#define AT91C_TC_CLKS_MCK_128 ((unsigned int) 0x3)       // (TC) Clock Selection MCK/128
#define AT91C_TC_CLKS_MCK_1024 ((unsigned int) 0x4)      // (TC) Clock Selection MCK/1024
#define AT91C_TC_CLKS_MCK_XC0 ((unsigned int) 0x5)       // (TC) Clock Selection XC0
#define AT91C_TC_CLKS_MCK_XC1 ((unsigned int) 0x6)       // (TC) Clock Selection XC1
#define AT91C_TC_CLKS_MCK_XC2 ((unsigned int) 0x7)       // (TC) Clock Selection XC2
#define AT91C_TC_BURST_NONE   ((unsigned int) 0 << 4)    // (TC) Burst Signal Selection None
#define AT91C_TC_BURST_XC0    ((unsigned int) 0x1 << 4)  // (TC) Burst Signal Selection XC0
#define AT91C_TC_BURST_XC1    ((unsigned int) 0x2 << 4)  // (TC) Burst Signal Selection XC1
#define AT91C_TC_BURST_XC2    ((unsigned int) 0x3 << 4)  // (TC) Burst Signal Selection XC2
